...
- You can now customize template roots relative to the workspace and import paths.

## [0.0.13] - 2025-12-27

### Added

- The globals LS command can now accept HTTP and HTTPS URLs.
- The globals LS command can now parse JSON schema files and add rich globals from them.
- There is support for Typst Jinja templates.
